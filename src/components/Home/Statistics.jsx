    ...
    <div className="container">
        <div className="row g-4">
            ...
            <div className="col-xl-5">
                <div className="image">
                    <img src="/images/service/service-three-image3.png" alt="leaf" />
                </div>
            </div>
            <div className="col-xl-5">
                <div className="section-header2">
                    <h5 className="wow fadeInUp" data-wow-duration="1.2s" data-wow-delay=".2s"><img
                            src="/images/icon/leaf.png" alt="leaf" style={{display:"inline"}}/> TREE PLANTING</h5>
    ...
    <div className="container">
        <div className="row g-4">
            ...
            <div className="col-xl-5">
                <div className="section-header2">
                    <h5 className="wow fadeInUp " data-wow-duration="1.2s" data-wow-delay=".2s"><img
                            src="/images/icon/leaf.png" alt="leaf" style={{display:"inline"}}/> TRACKING & VERIFICATION</h5>
             ...
             <div className="col-xl-6">
                <div className="image">
                    <img src="/images/service/service-three-image4.png" alt="service"/>
                </div>
            </div>
        </div>
    </div>
...
<section className="statistic-area pt-60 pb-60">
    <div className="container">
        <div className="row g-4">
            <div className="col-xl-6">
                <div className="image">
                    <img src="/images/service/service-three-image5.png" alt="leaf"/>
                </div>
            </div>
            <div className="col-xl-5">
                <div className="section-header2">
                    <h5 className="wow fadeInUp" data-wow-duration="1.2s" data-wow-delay=".2s"><img
                            src="/images/icon/leaf.png" alt="leaf" style={{display:"inline"}}/> TREE TAGGING</h5>
