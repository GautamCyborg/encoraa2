            ...
            <div className="col-xl-5">
                <div className="section-header2">
                    <h5 className="wow fadeInUp" data-wow-duration="1.2s" data-wow-delay=".2s"><img
                            src="/images/icon/leaf.png" alt="leaf"/> TREE PLANTING</h5>
    ...
    <div className="container">
        <div className="row g-4">
            ...
            <div className="col-xl-5">
                <div className="section-header2">
                    <h5 className="wow fadeInUp " data-wow-duration="1.2s" data-wow-delay=".2s"><img
                            src="/images/icon/leaf.png" alt="leaf"/> TRACKING & VERIFICATION</h5>
    ...
    <div className="container">
        <div className="row g-4">
            ...
            <div className="col-xl-5">
                <div className="section-header2">
                    <h5 className="wow fadeInUp" data-wow-duration="1.2s" data-wow-delay=".2s"><img
                            src="/images/icon/leaf.png" alt="leaf"/> TREE TAGGING</h5>
